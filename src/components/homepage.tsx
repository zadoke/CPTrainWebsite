            ...
            <div className="flex items-center justify-center bg-white min-h-screen">
              <div className="flex flex-col items-center">
                      ...
                      {formSubmitted && selectedStationId === null && (
                        <div className="font-inter justify-center w-80 bg-gray-100 rounded-full backdrop-blur-sm shadow-xl transition-all duration-700 ease-in-out transform  my-4 py-4 px-8 text-center " role="alert">
                          <span className="block sm:inline text-center">Seleciona uma estação da lista.</span>
                        </div>
                      )}
